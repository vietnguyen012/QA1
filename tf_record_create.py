...
def read_squad_examples(input_file=None,data=None, is_training=False,input_data=False):
  ...
  return examples
#_convert_index(chartok_to_orig_index, start_chartok_pos,n, is_start=True)
def _convert_index(index, pos, m=None, is_start=True):
  """Converts index."""
  if index[pos] is not None:
    # print("pos:",pos)
    # print("index[pos]:",index[pos])
    return index[pos]
  n = len(index)
  #print("n:",n)
  rear = pos
...
#_check_is_max_context(doc_spans, doc_span_index,split_token_index)
...
if __name__ == '__main__':
  examples=read_squad_examples(input_file='/home/vietnguyen/albert_vi/Dataset/trial.json',is_training=True,input_data = False)

  tokenizer = tokenization.FullTokenizer(
        vocab_file="/home/vietnguyen/albert_vi/assets/albertvi_30k-clean.vocab", do_lower_case=True,
        spm_model_file="/home/vietnguyen/albert_vi/assets/albertvi_30k-clean.model")
  train_writer = FeatureWriter(
            filename="/home/vietnguyen/albert_vi/Dataset/xquad.vi.rtf", is_training=True)

  convertExampleToFeature=convert_examples_to_features(examples,tokenizer=tokenizer,
                                                     max_seq_length=384,
                                                     doc_stride=128,
                                                     max_query_length=64,
                                                     is_training=True,
